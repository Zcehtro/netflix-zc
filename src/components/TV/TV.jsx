...
export default function TV() {
  ...
  const endpoints = [
    `https://api.themoviedb.org/3/tv/${params.id}?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=en-US`,
    `https://api.themoviedb.org/3/tv/${params.id}/credits?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=en-US`,
    `https://api.themoviedb.org/3/tv/${params.id}/external_ids?api_key=${process.env.REACT_APP_TMDB_API_KEY}`,
    `https://api.themoviedb.org/3/movie/${params.id}/release_dates?api_key=${process.env.REACT_APP_TMDB_API_KEY}`,
    `https://api.themoviedb.org/3/tv/${params.id}/similar?api_key=${process.env.REACT_APP_TMDB_API_KEY}&language=en-US&page=1`,
    `https://api.themoviedb.org/3/tv/${params.id}/images?api_key=${process.env.REACT_APP_TMDB_API_KEY}&include_image_language=en`,
  ];
